# 📚 Índice da Documentação - PM AI MVP
...
|-----------|-----------|---------|-------------------|
| [README.md](./README.md) | Setup completo e arquitetura da aplicação | ✅ Atualizado | 29/08/2025 |
| [ESTRUTURA_PROJETO.md](./ESTRUTURA_PROJETO.md) | Organização e estrutura do projeto | ✅ Atualizado | Janeiro 2025 |

### **🧭 Regras e Diretrizes**
| Documento | Propósito | Status | Última Atualização |
|-----------|-----------|---------|-------------------|
| [regras.mdc](../regras.mdc) | Regras do projeto (Cursor) e diretrizes UX/UI resumidas | ✅ **NOVO** | 29/08/2025 |
...
| Documento | Propósito | Status | Última Atualização |
|-----------|-----------|---------|-------------------|
| [REQUISITOS.md](./REQUISITOS.md) | Padrões técnicos e convenções de código | ✅ Atualizado | 29/08/2025 |
| [SPEC.md](./SPEC.md) | Especificações do produto e funcionalidades | ✅ Atualizado | 29/08/2025 |
